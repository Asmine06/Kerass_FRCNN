...
def get_noise_data (input_path , name_data, per_noise_label):
        all_imgs = []
        #pdb.set_trace()
        classes_count = {}

        class_mapping = {}
        Nclass_mapping = ['person', 'cat', 'boat', 'chair', 'dog', 'tvmonitor', 'train', 'car', 'bottle',  'diningtable', 'sofa', 'pottedplant', 'aeroplane', 'sheep', 'bus', 'bird','bicycle',  'cow',  'motorbike',  'horse',>        visualise = False
